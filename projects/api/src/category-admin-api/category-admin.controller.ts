...
export class AdminCategoryController {
  ...
  public async getAllCategory(@Query() request: AdminGetCategoryRequest): Promise<PaginatedList<AdminGetCategoryResponse>> {
  ...
  public async getCategoryById(@Param('id') id: string): Promise<AdminGetCategoryResponse> {
    try {
  ...
  @Post('/create')
  async createCategory(@Body() params: AdminCreateCategoryParams): Promise<AdminCreateCategoryResponse> {
    try {
  ...
  @Post('/:id/edit')
  async editCategory(@Param('id') id: string, @Body() params: AdminUpdateCategoryParams): Promise<AdminUpdateCategoryResponse> {
    try {
